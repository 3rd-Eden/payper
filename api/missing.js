 ...
 *
 * @param {String} name The unsanitized name of the bundle that is missing.
 * @param {String} version The unsanitized version of the bundle that is missing.
  ...
  const payload = `
    if (typeof console !== 'undefined' && console.error && console.group) {
      [
        ...
        ['error', 'To learn more go to: http://github.com/3rd-Eden/payper#missing']
        ['groupEnd']
